          ...
          <div>
            ...
            <div className="space-y-2">
              {STORE_HOURS.map((schedule) => (
                <div key={schedule.day} className="flex justify-between text-purple-50 text-sm">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-2 text-purple-50 hover:text-white transition-colors text-sm"
              >
              ...
              <p className="flex items-start gap-2 text-purple-50 text-sm">
