    ...
    <footer className="bg-gradient-to-br from-primary to-teal-700 text-white py-12">
      <div className="container mx-auto px-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <img
                ...
                src={LOGO_URL}
              />
              <span className="text-xl font-bold">Açaiteria Capixaba</span>
            </div>
            <p className="text-teal-50 text-sm">
              O melhor açaí de Guarulhos, feito com carinho e ingredientes selecionados.
            </p>
          </div>

          <div>
            <h3 className="font-bold text-lg mb-4">Horário de Funcionamento</h3>
            <p className="text-teal-50 text-sm mb-2">
              <strong>Segunda a Domingo</strong>
            </p>
            <p className="text-teal-50 text-sm">11:00 às 23:00</p>
          </div>
        ...
        <div className="border-t border-teal-500 mt-8 pt-6 text-center text-teal-50 text-sm">
          <p>© 2025 Açaiteria Capixaba. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
