      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a
            ...
            className="bg-white text-primary px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-50 transition-all transform hover:scale-105 whitespace-nowrap shadow-xl flex items-center gap-2"
          >
